                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="p-2 align-middle text-center bg-transparent border-b whitespace-nowrap shadow-transparent">
                                        <a href="javascript:;" wire:click="edit({{ $teacher->id }})" class="mx-3"
                                            data-bs-toggle="tooltip" data-bs-original-title="Modifier">
                                            <i class="fas fa-user-edit text-secondary"></i>
                                        </a>
                                        <a href="javascript:;" wire:click="delete({{ $teacher->id }})"
        ...
        <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl bg-clip-border"
                ...
                <div class="pt-6 pl-6 pr-6 mb-0 rounded-t-2xl">
                    <h5 class="dark:text-white">{{ $editMode ? 'Modifier le professeur' : 'Ajouter un professeur' }}</h5>
                ...
                <div class="flex-auto p-6 pt-0">
                    <form wire:submit.prevent="save">
                        ...
                        <div class="mb-4">
                            <label for="specialty" class="block mb-2 text-sm font-bold text-gray-700">Spécialité</label>
                            <input type="text" wire:model="specialty" id="specialty"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            @error('specialty') <span class="text-sm text-red-500">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-4">
                            <label for="selectedSubjects" class="block mb-2 text-sm font-bold text-gray-700">Matières</label>
                            <select wire:model="selectedSubjects" id="selectedSubjects" multiple
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
