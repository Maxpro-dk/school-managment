                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                                    <h3 class="relative z-10 font-bold text-transparent bg-gradient-to-tl from-blue-600 to-cyan-400 bg-clip-text">Bienvenue</h3>
                                ...
                                <div class="flex-auto p-6">
                                    ...
                                    <form wire:submit.prevent="login">
                                        ...
                                        <div class="text-center">
                                            <button type="submit"
                                            class="inline-block w-full px-6 py-3 mt-6 mb-0 font-bold text-center text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer shadow-soft-md bg-x-25 bg-150 leading-pro text-size-xs ease-soft-in tracking-tight-soft bg-gradient-cyan hover:scale-102 hover:shadow-soft-xs active:opacity-85">Se connecter</button>
                                        </div>
                                    </form>
                                </div>
                                <div
                                    ...
                                    <p class="mx-auto mb-6 leading-normal text-size-sm">
                                        Vous n'avez pas de compte ? <a href="{{ route('register') }}"
                                            class="font-bold text-slate-700">S'inscrire</a>.<br />
                                        <a href="{{ route('forgot-password') }}"
                                            class="font-bold text-slate-700">Mot de passe oublié ?</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
